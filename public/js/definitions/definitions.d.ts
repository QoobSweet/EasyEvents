...
export interface AccessData {
    ...
    type: "number" | "color" | "text" | "search" | "tel" | "url" | "email" | "password" | "date" | "month" | "week" | "time" | "datetime-local" | "select" | "coorespondence";
    options?: string[] | null;
...
export declare const compressKey: (key: string) => string;
export declare const decompressKey: (key: string) => string;
